...
int main(){
	...
	printf("---Test correctness of Algorithm 2---\n");
        test_file();
        printf("Please check MSS_Results.txt\n");
	//Experimental run-time analysis array size from 100 - 9000
	int j, value;
	int *testArray, interval_l, interval_h;;
	clock_t timer;
